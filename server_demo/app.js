...
app.post("/admin/login",function(req,res){
    ...
    console.log(req.body);
    var message = ""
    connection.query('SELECT username FROM login where username = ?',[username], function(err, result) {
        if (err) throw err;
    ...
    connection.query('SELECT username FROM login where username = ? AND password = ?',[username,password], (err, result) => {
